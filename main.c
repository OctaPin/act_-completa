...
int main() {
    ...
    while(1) {
        ...
        float fahrenheit= celsius_to_fahrenheit(temperature_c);
         printf("la humedad es %.2f y la temperatura %.2f ºF  y la temperatura %.2f",humidity,fahrenheit,temperature_c);
